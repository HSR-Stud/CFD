...
\colorbox{red}{k-$\epsilon Modell$ und Bilder aus Buch}
...
werden. $\Rightarrow$ Spart Rechenleistung bei akkuraten Resultaten.
 ...
 \colorbox{red}{Bitte ergänzen Silvio von letztes Jahr!}
...
Explain why the CDS (central differencing scheme) does not work for large velocities.
