...
Rechenzeitenvergleich Tabelle erstellen

\subsection{Jacobi and Gauss-Seidel iterative methods}
Describe the Jacobi and Gauss-Seidel iterative methods
\begin{itemize}
\item \textbf{Jacobi iterative method:} 

Zu beachten ist das $\lambda$ (Eigenwert) kleiner 1 sein muss, dass es konvergiert, je kleiner desto langsamer wird es jedoch.
