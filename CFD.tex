...
\item \textbf{Cranck-Nicholson}:  Basiert auf Central Differencing, deshalb 2nd
Order Accuracy. Kleinere Time Step Limitation $\Rightatrrow$ sehr gute Resulate
...
\item \textbf{Cranck-Nicholson}: Ebenfalls Time Step Limit $\Rightarrow$ Weniger
